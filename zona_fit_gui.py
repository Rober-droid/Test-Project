...
class App(tk.Tk):
    ...
    def cargar_cliente(self, event):
        ...
        #Antes de cargare, limpiamos el formulario
    ...
    def eliminar_cliente(self):
        if self.id_cliente is None:
            showerror(title='Atencion',
                      message='Debe seleccionar un cliente a elmiminar')
        else:
